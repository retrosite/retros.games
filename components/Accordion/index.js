...
/*
  The preserveInnerState prop is actually mission-critical. It is 
	used on the contact page to make sure that the contact forms are
	included in the static page HTML, which is necessary for Netlify to find them at build time.
*/
...
export default function Accordion({
  ...
  useEffect(() => {
    // Once mounted, check if the URL #hash matches the ID, and if so, open.
